...
\begin{xtabular}{l |  l | l}\toprule 
	...
	\tab \verb=\recfnl[s]{e}{Y}{x}=                             & \( 	\recfnl[s]{e}{Y}{x}                   	   \)   & \\[6pt]
	\tab \verb=\recfnl{e}{Y}{}=                                 & \( 	\recfnl{e}{Y}{}                       	   \)   & \\[6pt]
	\tab \verb=\recfnl{e}{}{x}=                                 & \( 	\recfnl{e}{}{x}                       	   \)   & \\[6pt]
	\tab \verb=\recfnl{e}{}{}=                                  & \( 	\recfnl{e}{}{}                        	   \)   & \\ \midrule
	...
	\tab \verb=\REset[s]{e}=                                    & \( 	\REset[s]{e}                          	   \)   & \\[6pt] 
	\tab \verb=\REset(X){e}=                                    & \( 	\REset(X){e}                          	   \)   & \\[6pt] 
	\tab \verb=\REset[s](X){e}=                                 & \( 	\REset[s](X){e}                       	   \)   & \\ \midrule
	...
	\tab \verb=\alphaREAop[f]{\alpha}(\eset)=                   & \multirow{2}{*}{\( 	\alphaREAop[f]{\alpha}(\eset)         	   \)}   & \multirow{2}{*}{with particular witness to uniformity}\\[6pt]
	...
	\tab \verb=X \Tjoin Y=                                      &  & \\ 
	\tab \verb=\TPlus_{i \in \omega} X_i=                       & \multirow{2}{*}{\( 	\TPlus_{i \in \omega} X_i            \)}   & \\ 
...
\begin{tabular}{l |  l | l}\toprule                                
	...
	\tab \verb=\exists*[x < y]=		& \( \exists*[x < y ] \) & \\[6pt]
	\tab \verb=\exists*(x < y)=		& \( \exists*(x < y ) \) & \\ \midrule
	\verb=\nexists[x < y]=		& \( \nexists[x < y ] \) & \\[6pt]
	\tab \verb=\nexists(x < y)=		& \( \nexists(x < y ) \) & \\ \midrule
	\verb=\nexists*=		& \multirow{2}{*}{\( \nexists* \)} & \\[6pt]
	...
	\tab \verb=\forall*[x < y]=		& \( \forall*[x < y ] \) & \\[6pt]
	\tab \verb=\forall*(x < y)=		& \( \forall*(x < y ) \) & \\ \midrule
...
\begin{tabular}{l |  l | l}\toprule  
	...
	\tab \verb=\sigma\concat[0]=             & \(   \sigma\concat[0]      \) &   \\ \midrule
...
\begin{tabular}{l |  l | l}\toprule  	
	...
	\tab \verb=\CBderiv[\alpha]{T}=           & \(  \CBderiv[\alpha]{T}       \) & \\ \midrule
...
\begin{tabular}{l |  l | l}\toprule 
  ...
  \tab \verb=X \subseteq* Y=            & \( X \subseteq*  Y\)  & \\ \midrule
       \verb=X \supset* Y=              & \( X \supset*    Y\)  & \multirow{2}{*}{All but finitely much of \( Y \) is in \( X \)} \\ 
  \tab \verb=X \supseteq* Y=            & \( X \supseteq*  Y\)  & \\ \midrule

...
We can now reference the case number \ref{case:second}.
...
Now to ref case \ref{case*:second}.
...
\case[\( x = z \land z > q \land z < r \land x + z = r \)] \label{case:second} Second case
\end{pfcases}
\end{proof}
